...
public class FindingNearestfriendsService extends Service {
	JSONArray array;
	...
	void getData() {
		...
		if (response.trim().equalsIgnoreCase("empty")) {
			/*
			 * Toast .makeText(NearbyActivity.this, "please add your friends",
			 * 3000).show();
			 */
				...
				if (location != null) {
					...
					for (int i = 0; i < array.length(); i++) {
						...
						if (distance(Double.parseDouble(array.getJSONObject(i)
							...
							number.add(array.getJSONObject(i).getString(
									"number"));
